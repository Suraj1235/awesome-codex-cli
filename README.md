...
- [Suraj1235/open-dynamic-workflows](https://github.com/Suraj1235/open-dynamic-workflows) - Open-source dynamic multi-agent workflow engine for Codex, Antigravity, OpenCode, and VS Code; ships a Codex skill folder (SKILL.md + daemon bridge) and an OpenCode plugin, with bring-your-own-model support (Anthropic, OpenAI-compatible, Ollama). ![GitHub stars](https://img.shields.io/github/stars/Suraj1235/open-dynamic-workflows?style=flat-square)
